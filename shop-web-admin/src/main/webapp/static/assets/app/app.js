var App = function () {
    ...
    var handlerDeleteMulti =function(url) {
        ...
        _checkbox.each(function () {
            ...
            if (_id != null && $(this).is(":checked")&& _id !== "undefined" ) {
                _idArray.push(_id);
            }
        });
            ...
            setTimeout(function () {
                $.ajax({
                    ...
                    "success": function (data) {
                        ...
                        $("#btnModalOFF").attr("style","display:none;");
     ...
     * @param columns
     */
    var handlerInitDataTbles = function (url, columns) {
    ...
    return {
        ...
        initDataTables: function (url, columns) {
            return handlerInitDataTbles(url, columns);
        },
